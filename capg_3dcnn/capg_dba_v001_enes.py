# %% [markdown]
# # Gesture Recognition with CAPG DB-a Dataset Using 3D CNN with EMGNet Architecture (5 trials for testing)
# 
...
# - **Training data:** 5 trials selected randomly
# - **Test data:** 5 other trials
...
k_fold_study = {
    ...
    "k_fold_mode":"5 trials for testing",
    "k":10,
...
# %%
hparams = {
    "model_name": autoname("capg_3dcnn_dba_v001"),
...
num_trials = dba['trial'].nunique()

ds = k_fold_study['global_downsampling']

for k in range(k_fold_study['k']):
    
    print("\n#################################################################")
    print("Performing Random Attempt No. %d ..." % (k+1))
    print("#################################################################\n")
    
    print("Generating data ...")
    
    # Number of trials in the dataset
    trials_for_testing = np.random.permutation(num_trials).tolist()[:num_trials//2]
    print("Trials for testing: ", trials_for_testing)
    ...
    data_processed = generate_cell_array(
        ...
        trials_for_testing=trials_for_testing,
    ...
    print("Extracting and downsampling training and testing inputs and outputs from tabulated data cell ...")
    ...
    print("Generating TensorDataset objects ...")
    ...
    print("Updating relevant fields in the dictionary for logging ...")
...
# %%
print("Saving general statistics ..")
